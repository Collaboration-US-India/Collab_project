#This is a collaboration containing the codes of my teammate along with mine
#Load data
setwd("C:/Users/FIONA/Desktop/Seattle Project")
...
#Here I am visualising the data
...
View(Us_p)
#I have calculated the count of each type of patent
